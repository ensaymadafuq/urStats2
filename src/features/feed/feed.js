import { getUsername } from "../../shared/storage.js";
...
export function loadFeed() {
  ...
  if (logDatas) {
    ...
    logsArray.forEach((log) => {
      ...
      feed1.innerHTML = `
         <img
          src="../public/assets/MAIN PAGE/Sample profile.png"
          alt=""
        ...
        <div class="f-details">
          ...
          <div class="fmid">
            ...
            <div class="fstars">
          ${Array.from({ length: log.stars }, () => '<i class="fa fa-star selected"></i>').join("")}
            </div>

            <img src="../public/assets/feed/Icon.png" alt="" class="mid-heart" />
          </div>
          ...
          <div class="bot-btns">
            <div class="btn-heart">
          <img src="../public/assets/feed/Icon.png" alt="" />
          <p>Like&nbsp;log</p>
            </div>

            <div class="btn-comment">
          <p>1</p>
          <img src="../public/assets/feed/Message square.png" alt="" />
            </div>
          </div>
        </div>
        `;
